...
const ProfileUpperSection = () => {
  return (
    <div className='bg-purple-700 w-full h-90'>
        <div className='bg-white w-full h-80 relative top-30 rounded-t-full flex flex-col items-center gap-4'>
            ...
            <div className='flex justify-around w-full'>
                <button className='w-45 h-13 border border-gray-100 rounded-xl bg-purple-600 text-white font-medium'>Edit Profile</button>
                <button className='w-45 h-13 border border-gray-100 rounded-xl bg-purple-600 text-white font-medium'>Share Profile</button>
            </div>
        </div>
    </div>
  )
