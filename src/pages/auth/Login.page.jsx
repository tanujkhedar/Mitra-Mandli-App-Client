  ...
  return (
    <div className="h-dvh flex items-center justify-center bg-gray-100 text-black p-4">
      <div className="w-full max-w-sm p-4 bg-white rounded-2xl shadow space-y-6">
        ...
        <button className="w-full p-3 rounded-lg bg-linear-to-r from-purple-600 to-violet-500 font-semibold" onClick={loginHeandler}>
        ...
        <p className="text-center text-gray-400">
          ...
          <Link to='/register' className="text-violet-500 cursor-pointer">
            Sign up
          </Link>
        </p>
